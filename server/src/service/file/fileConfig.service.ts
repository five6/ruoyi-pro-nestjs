import {
  ...
  import { FileConfigPageDto, FilePageDto } from '../../dto/file/FileDto';
import { FileConfig } from 'src/entity/file/fileConfigEntity';
  ...
  export class FileConfigService {
    constructor(
      ...
      @InjectRepository(FileConfig)
      public readonly repository: MongoRepository<FileConfig>,
    ) {}
  
    async find(dto: FileConfigPageDto) {
